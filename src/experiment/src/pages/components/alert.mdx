...
import Customize from '../../components/Customize.astro'
    ...
    <TabItem label="Preview">
        <Card>
            <div class="alert" role="alert">
                ...
                <span>This is simple alert</span>
                <div>
                    <button type="button" class="btn btn-xs !mt-0">Exit</button>
                    <button type="button" class="btn btn-xs btn-primary !mt-0">Confirm</button>
                </div>
            </div>
            <div class="alert alert-success" role="alert">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span>This is simple alert</span>
                <div>
                    <button type="button" class="btn btn-xs btn-success !mt-0">Exit</button>
                    <button type="button" class="btn btn-xs !mt-0">Confirm</button>
                </div>
            </div>
        </Card>
    </TabItem>
...
Refer to the [Configuration Guide](/getting-start/configure) to learn more about how to set up and customize the components according to your project's needs.
